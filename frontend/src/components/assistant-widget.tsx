    ...
    <>
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-glow transition-transform hover:scale-110 z-50 p-0"
        >
          <div className="relative flex h-full w-full items-center justify-center rounded-full bg-gradient-primary">
      ...
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 flex h-[600px] w-[380px] flex-col overflow-hidden rounded-2xl border border-border/60 bg-card/95 shadow-elegant backdrop-blur-xl animate-in slide-in-from-bottom-5">
          {/* Header */}
