...
- **Orquestração de Inteligência Artificial:**
  - Node.js (ou Python) rodando funções Serverless (Edge Functions) ou processos em background (Workers).
...
- **Modelo recomendado:** `Claude 3.5 Sonnet` (Anthropic) ou `gpt-4o` (OpenAI) devido à sua superioridade em lógica e escrita humanizada.
