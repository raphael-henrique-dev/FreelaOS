        ...
        try:
            with sync_playwright() as p:
                ...
                try:
                    ...
                    url_alvo = f"https://www.99freelas.com.br/projects?categoria={cat_slug}"
                    ...
                    try:
                        ...
                        logger.info(f"[99Freelas] Nenhuma vaga encontrada para a área {area_atuacao}.")
                        return []
                        
                    projetos = page.locator(".result-list li.result-item")
                    total = projetos.count()
                    logger.info(f"[99Freelas] Encontradas {total} vagas para {area_atuacao}.")
